...
[![Minhas Habilidades](https://skillicons.dev/icons?i=javascript,typescript,nodejs,express,nest,dotnet,c#,spring,hibernate,java,python,django,jest,prisma,postgres,mongodb)](https://skillicons.dev)
